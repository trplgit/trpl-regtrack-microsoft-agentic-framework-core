...
IF OBJECT_ID('dbo.InsightsAgentReasoningLog', 'U') IS NOT NULL DROP TABLE dbo.InsightsAgentReasoningLog;   -- sql/31, permanent home for agent reasoning summaries (outlives any future DTFx purge)
